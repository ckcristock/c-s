...
//Application Title
define('APP_TITLE', 'SIGMAQMO - GESTOR DE ARCHIVOS');
...
//$root_path = $_SERVER['DOCUMENT_ROOT'] . '/DOCUMENTOS' . '/ordenes-produccion';

$root_path = $_SERVER['DOCUMENT_ROOT'] . '/DOCUMENTOS' . '/ordenes-produccion';

//BRAYAN DAVILA
if (isset($_GET['fijo'])) {
    if (fm_mkdir($root_path . '/' . $_GET['fijo'], true)) {
        $root_path = $_SERVER['DOCUMENT_ROOT'] . '/DOCUMENTOS' . '/ordenes-produccion' . '/' . $_GET['fijo'];
        defined("EL_FIJO" || define('EL_FIJO', $_GET['fijo']));
    }
}

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/DOCUMENTOS' . '/ordenes-produccion';
...
$directories_users = array(
    ...
    'ordenes-produccion' => '../DOCUMENTOS/ordenes-produccion',
);
...
//BRAYAN DAVILA
if (!isset($_GET['fijo'])) {
    fm_redirect(FM_SELF_URL . '?p=' . urlencode(FM_PATH) . '&fijo=');
} 
// AJAX Request
