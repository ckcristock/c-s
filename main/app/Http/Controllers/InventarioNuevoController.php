...
class InventarioNuevoController extends Controller
{
    ...
    public function listar()
    {
        ...
        if (isset($_REQUEST['nom']) && $_REQUEST['nom'] != "") {
            $condicion .= " AND (PRD.Nombre_Comercial LIKE '%$_REQUEST[nom]%')";
        }
        ...
        $query = 'SELECT
            ...
            CONCAT(PRD.Cantidad, " ", PRD.Unidad_Medida, " ") AS Nombre_Producto,
            ...
            $query .= $condicion_principal . ' ' . $condicion . $condicion_sin_inventario . '
                GROUP BY B.Id_Bodega_Nuevo, IC.Id_Inventario_Nuevo, I.Id_Producto,I.Lote,I.Fecha_Vencimiento, I.Codigo_Cum' .
