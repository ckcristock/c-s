<div>
            ...
            <table class="w-100">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2"> {{ Carbon\Carbon::parse($info['date_of_admission'])->locale('es_ES')->isoFormat('dddd, D \d\e MMMM YYYY') }} </td>
                    </tr>
                </tbody>
            </table>
        ...
        <table class="w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($info['deducciones']['valor_total'] + $info['retencion']['valor_total'],2,',','.') }}</td>
                </tr>
                <tr>
    ...
    <small class="text-center">
        <b>
            <br>
            Nota: Lo expuesto en este comprobante representa el pago {{ $data['frecuencia_pago'] }} del empleado, y en este
            se
