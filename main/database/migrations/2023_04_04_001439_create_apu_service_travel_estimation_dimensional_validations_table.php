...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('apu_service_travel_estimation_dimensional_validations', function (Blueprint $table) {
            $table->integer('id', true);
            $table->integer('apu_service_dimensional_validation_id')->nullable();
    ...
    {
        Schema::dropIfExists('apu_service_travel_estimation_dimensional_validations');
    }
};
