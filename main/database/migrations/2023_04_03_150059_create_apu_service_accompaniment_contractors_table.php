...
class CreateApuServiceAccompanimentContractorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('apu_service_accompaniment_contractors', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('apu_service_accompaniment_contractors');
    }
}
